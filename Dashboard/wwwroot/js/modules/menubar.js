define(["jquery-ui"], function($) {
	...
	Menubar.initialize = function(namespace) {
		...
		$("*[data-partialview]").on("click", this.togglePartialView);
	...
	Menubar.togglePartialView = function (e) {
		var partialViewName = $(e.currentTarget).data("partialview");
		console.log("Opening partial view: " + partialViewName);

		// Load the corresponding partial view and insert it into the target content div
		$.get(partialViewName, function (data) {
			var targetContent = $(e.currentTarget).data("targetcontent");
